"""Governed delegation to an external coding harness.

Will owns the campaign/governance decision; an external coding-harness CLI
(Claude Code / Codex) is a bounded HAND. A delegation is a NETWORK_READ-class ActionProposal: it must pass the policy gate
...
See docs/adr-002-pi-agent-delegated-execution.md and docs/adr-006-will-harness-kernel.md.
"""
...
from will.config import DelegationConfig
...
from will.autonomy.budget import action_cost, can_afford, spend
from will.autonomy.gates import DELEGATION_SENTINEL, run_policy_gate
from will.ledger.store import append_event
...
TRANSCRIPT_DIR = Path(".will/delegation-transcripts")
